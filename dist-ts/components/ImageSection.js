...
export function ImageSection({ settings, onUpdate, onLoadImage }) {
    ...
    return (<CollapsibleSection title="Image" defaultOpen={true}>
      ...
      <div className="control-group">
        <label>
          Pixel Size:
          <input type="range" min="1" max="20" step="1" value={settings.pixelSize} onChange={(e) => handleChange('pixelSize', parseInt(e.target.value))}/>
