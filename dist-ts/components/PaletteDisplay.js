...
export function PaletteDisplay({ palette, settings }) {
    ...
    return (<div className="palette-display">
      ...
      <div className="palette-colors">
        {palette.map((colorRgb, index) => {
            ...
            return (<div key={index} className="palette-color" style={{ backgroundColor: colorHex }} title={colorHex}/>);
        })}
      </div>
    </div>);
}
//# sourceMappingURL=PaletteDisplay.js.map