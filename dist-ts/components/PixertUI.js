...
export function PixertUI({ imageProcessor, onUpdate }) {
    ...
    //   };
    return (<div className="pixert-ui">
      <div className="ui-container">
        <ImageSection settings={settings} onUpdate={updateSettings} onLoadImage={handleLoadImage}/>
        
        {imageProcessor.base64Image && (<OriginalImageSection img={imageProcessor.base64Image}/>)} 

        <AdjustmentsSection settings={settings} onUpdate={updateSettings}/>
        
        <ColorsSection settings={settings} onUpdate={updateSettings}/>
        
        <DitheringSection settings={settings} onUpdate={updateSettings}/>
        
        <ScanlinesSection settings={settings} onUpdate={updateSettings}/>

        <OverlaySection settings={settings} onUpdate={updateSettings}/>
        
        <ExportSection settings={settings} onUpdate={updateSettings} onSaveImage={handleSaveImage}/>
...
//# sourceMappingURL=PixertUI.js.map