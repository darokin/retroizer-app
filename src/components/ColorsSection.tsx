    ...
    <CollapsibleSection title="Colors" defaultOpen={true}>
      ...
      <div className="control-group">
        <label className="checkbox-label">
          <input
            type="checkbox"
            checked={settings.colorLimit}
            onChange={(e) => handleChange('colorLimit', e.target.checked)}
          />
          Color Limit
        </label>
      </div>
      ...
      <div className="control-group">
        <label className="checkbox-label">
          <input
            type="checkbox"
            checked={settings.customPalette}
            onChange={(e) => handleChange('customPalette', e.target.checked)}
          />
          Custom Palette
        </label>
      </div>
        ...
        <div className="control-group">
          <label>
            ...
            <select
              ...
              onChange={(e) => handleChange('paletteType', e.target.value)}
            >
