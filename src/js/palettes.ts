...
export { getPalette, findNearestColor, kMeansQuantize };

// Exposer globalement pour compatibilité
(window as any).getPalette = getPalette;
(window as any).findNearestColor = findNearestColor;
(window as any).kMeansQuantize = kMeansQuantize;